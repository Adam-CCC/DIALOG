qx.Class.define("scada.widget.period.DateTimeField", {
    ...
    members: {
        ...
        _createChildControlImpl(id, hash){
            ...
            switch(id) {
                case "datefield":
                    ...
                    break;
                case "timefield":
                    control = new scada.widget.time.Field();
                    control.setValue(0);
                    this._add(control);
                    break;
            }
        ...
        getValue(){
            ...
            scada.widget.period.helper.DateTime.addTimeToDate(date, time);
            return date;
        },
        ...
        setValue(value){
            ...
            const seconds = scada.widget.period.helper.DateTime.getSeconds(value);
